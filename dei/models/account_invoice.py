...
class account_invoice(models.Model):
	...
	def to_word(self,number, mi_moneda):
		...
		MONEDAS = (
			...
			{'country': u'Guatemala', 'currency': 'QTQ', 'singular': u'Quetzal', 'plural': u'Quetzales', 'symbol': u'Q'},
			{'country': u'Guatemala', 'currency': 'GTQ', 'singular': u'Quetzal', 'plural': u'Quetzales', 'symbol': u'Q'}
			)
		if mi_moneda != None:
			try:
