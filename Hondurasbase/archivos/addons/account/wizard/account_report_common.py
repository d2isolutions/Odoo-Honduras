...
class account_common_report(osv.osv_memory):
    ...
    _columns = {
        'download_excel':fields.binary('Download Excel',readonly=True),
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        if context.get('active_model', False) == 'account.account':
            ...
            nodes2=doc.xpath("//field[@name='filtrar_cuenta']")
            if nodes2:
                for node2 in nodes2:
                    node2.set('invisible','1')
                    setup_modifiers(node2,res['fields']['filtrar_cuenta'])
